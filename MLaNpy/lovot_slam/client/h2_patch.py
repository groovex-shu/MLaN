"""
Patch h2 transitions to fix RECV_GOAWAY frame issue
This is a workaround for the issue in h2 library and is copied from
  https://github.com/nameko/nameko-grpc
specifically introduced in
  https://github.com/nameko/nameko-grpc/pull/54
